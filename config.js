...
const CONFIG = {
    ...
    questions: {
        first: {
            text: "Te gusto de verdad?",                                    // First interaction
            yesBtn: "Si",                                             // Text for "Yes" button
            noBtn: "No",                                               // Text for "No" button
            secretAnswer: "No me gustas, te amoo! ❤️"           // Secret hover message
        },
        second: {
            text: "Cuanto me amas?",                          // For the love meter
            startText: "Así de mucho te amo!",                                   // Text before the percentage
